                  ...
                  <li class="nav-item">
                    ...
                    <div id="submenu-3" class="collapse submenu" style="">
                      <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <router-link :to="{ name: 'unit' }" class="nav-link">Unit <i class="bg-square icon icon-login"></i></router-link>
                        </li>
                        <li class="nav-item">
                            <router-link :to="{ name: 'item' }" class="nav-link">Item <i class="bg-square icon icon-paper-clip"></i></router-link>
                        </li>
                        <li class="nav-item">
                            <router-link :to="{ name: 'supplier' }" class="nav-link">Supplier <i class="bg-square icon icon-directions"></i></router-link>
                        </li>
                      </ul>
                    </div>
                  </li>
